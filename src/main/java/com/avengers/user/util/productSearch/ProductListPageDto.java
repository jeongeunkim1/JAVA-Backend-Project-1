package com.avengers.user.util.productSearch;
...
public class ProductListPageDto {
	private List<Product> list; 		// 리스트 데이터 콜렉션
	...
	public ProductListPageDto(List<Product> list, int startPageNo, int endPageNo,
